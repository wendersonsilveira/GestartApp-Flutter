...
@injectable
class GetInadimplenciasUseCase extends BaseFutureUseCase<Map<String, dynamic>, ResourceData> {
  RecebimentoRepository _recebimentoRepository;

  GetInadimplenciasUseCase(this._recebimentoRepository);

  @override
  Future<ResourceData<List<InadimplenciaEntity>>> call([Map<String, dynamic> filtro]) {
    return _recebimentoRepository.getInadimplencias(filtro);
  }
}
