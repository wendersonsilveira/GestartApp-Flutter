...
class DropdownButtonField3Widget extends StatefulWidget {
  ...
  @override
  _DropdownButtonField3WidgetState createState() =>
      _DropdownButtonField3WidgetState();
}

class _DropdownButtonField3WidgetState
    extends State<DropdownButtonField3Widget> {
  int oldValue;
  ...
  setCodConShared(int codord) async {
    ...
    SharedPreferences.getInstance()
        .then((value) => value.setInt('codord', codord));
  }
