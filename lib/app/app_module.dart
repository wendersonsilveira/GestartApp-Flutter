...
class AppModule extends Module {
  ...
  List<ModularRoute> get routers => [
        ...
        ChildRoute(RouteName.condominio,
            ModularChild: (_, args) => CondominioPage()),
        ChildRoute(RouteName.dashboard,
            ModularChild: (_, args) => DashboardPage()),
        ChildRoute(RouteName.ativar_condominio,
            ModularChild: (_, args) => AtivarCondominioPage()),
        ChildRoute(RouteName.cadastros,
            ModularChild: (_, args) => CadastrosPage()),
        ChildRoute(RouteName.pets, ModularChild: (_, args) => PetsPage()),
        ChildRoute(RouteName.assembleia,
            ModularChild: (_, args) => AssembleiaPage()),
        ChildRoute(RouteName.detalhes_assembleia,
            ModularChild: (_, args) => DetalhesAssembleiaPage(id: args.data)),
        // ChildRoute(RouteName.view_documento,
        //     ModularChild:  (_, args) => ViewDocumentosPage(
        //           url: args.data[0],
        //           title: args.data[1],
        //           document: args.data[2],
        //         )),
        ChildRoute(RouteName.cadastro_pet,
            ModularChild: (_, args) => CadastroPetPage(id: args.data)),
        ChildRoute(RouteName.boleto, ModularChild: (_, args) => BoletoPage()),
        ChildRoute(RouteName.detalhe_boleto,
            ModularChild: (_, args) => DetalheBoletoPage(idBoleto: args.data)),
        ChildRoute(RouteName.balancetes,
            ModularChild: (_, args) => BalancetePage()),
        ChildRoute(RouteName.infor_condominio,
            ModularChild: (_, args) => InforCondominioPage()),
        ChildRoute(RouteName.documentos,
            ModularChild: (_, args) => DocumentosPage()),
        ChildRoute(RouteName.home, ModularChild: (_, args) => HomePage()),
        ChildRoute(RouteName.informativo,
            ModularChild: (_, args) => InformativoPage(id: args.data)),
        ChildRoute(RouteName.alterar_perfil,
            ModularChild: (_, args) => AlterarPerfilPage(usuario: args.data)),
        ChildRoute(RouteName.painel_sindico,
            ModularChild: (_, args) => SindicoPage()),
        ChildRoute(RouteName.cadastro_espaco,
            ModularChild: (_, args) => CadastroEspacoPage(id: args.data)),
        ChildRoute(RouteName.balancetes,
            ModularChild: (_, args) => BalancetePage()),
        ChildRoute(RouteName.reservas,
            ModularChild: (_, args) => ReservaPage()),
        ChildRoute(RouteName.reservaUnidades,
            ModularChild: (_, args) => UnidadesPage()),
        ...
        ChildRoute(RouteName.reservaDados,
            ModularChild: (_, args) => DadosReservaPage(idReserva: args.data)),
        ChildRoute(RouteName.veiculos,
            ModularChild: (_, args) => VeiculosPage()),
        ChildRoute(RouteName.cadastroVeiculo,
            ModularChild: (_, args) => CadastroVeiculoPage(id: args.data)),
        ChildRoute(RouteName.listar_espacos,
            ModularChild: (_, args) => ListarEspacosPage()),
        ChildRoute(RouteName.pesquisaVoz,
            ModularChild: (_, args) => PesquisaPage()),
        ChildRoute(RouteName.recebimentos,
            ModularChild: (_, args) => RecebimentosPage()),
        ChildRoute(RouteName.gerenciar_reserva,
            ModularChild: (_, args) => GerenciarReservaPage()),
        ChildRoute(RouteName.contas_fixas,
            ModularChild: (_, args) => ContasFixasPage()),
        ChildRoute(RouteName.movimento_financeiro,
            ModularChild: (_, args) => MovimentoFinanceiroPage()),
        ChildRoute(RouteName.movimento_financeiro_detalhe,
            ModularChild: (_, args) => DetalheMovimentoPage(
        ...
        ChildRoute(RouteName.detalhes_reserva,
            ModularChild: (_, args) =>
                DetalhesReservaPage(idReserva: args.data)),
        ChildRoute(RouteName.contas_fixas,
            ModularChild: (_, args) => ContasFixasPage()),
        ChildRoute(RouteName.condominio_online_ativar,
            ModularChild: (_, args) => CondominioOnlinePage()),
        ChildRoute(RouteName.ativar_codigo_email,
            ModularChild: (_, args) => CodigoAtivacaoPage()),
        ChildRoute(RouteName.detalhe_balancete,
            ModularChild: (_, args) => DetalheBalancetePage(
                  idBalancete: args.data,
                )),
        ChildRoute(RouteName.relatorioReservas,
            ModularChild: (_, args) => RelatorioReservasPage()),
        ChildRoute(RouteName.listaReservas,
            ModularChild: (_, args) => ListaReservasPage(
                  params: args.data,
                )),
        ChildRoute(RouteName.informativos_page,
            ModularChild: (_, args) => InformativosPage()),
        ChildRoute(RouteName.error_page,
            ModularChild: (_, args) => ErroPage(
                  msgErro: args.data,
                )),
      ];
