...
class DetalheBoletoPage extends StatefulWidget {
  final String title;
  final int codord;
  const DetalheBoletoPage({Key key, this.title = "Boleto Digital", this.codord}) : super(key: key);

  @override
  _DetalheBoletoPageState createState() => _DetalheBoletoPageState();
}

class _DetalheBoletoPageState extends ModularState<DetalheBoletoPage, DetalheBoletoController> {
...
>>>>>>> ed2b9a0af5b178b0d434e6bc4fb87b6e43bd8b46
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextoInforWidget(
                            titulo: 'Vencimento',
                            valor: UIHelper.formatDateFromDateTime(controller.boleto.data.datVen),
                          ),
                          TextoInforWidget(titulo: 'Valor', valor: UIHelper.moneyFormat(controller.boleto.data.valTot))
                        ],
>>>>>>> ed2b9a0af5b178b0d434e6bc4fb87b6e43bd8b46
                      ),
                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: DownloadButtonWidget(
                            ...
                            fileName: 'Boleto_${controller.boleto.data.apelido}_${UIHelper.formatDate(controller.boleto.data.datVen)}.pdf',
                            fileURL: controller.boleto.data.linkBoleto,
                            shap: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18.0), side: BorderSide(color: AppColorScheme.primaryColor)),
                          ),
                        ),
                        ButtonExpandedWidget(
                          descricao: 'COPIAR CODIGO',
                          funcao: () {
                            Clipboard.setData(new ClipboardData(text: controller.boleto.data.linhaDigitavel));
                            key.currentState.showSnackBar(new SnackBar(
                              content: new Text("Código copiado com sucesso"),
                            ));
                          },
                        ...
                        ButtonExpandedWidget(
                          descricao: 'COMPARTILHAR',
                          funcao: () => _shareContent('Boleto Bancário ' + controller.boleto.data.linkBoleto),
                        ),
                      ],
                    ),
                  ),
                        ...
                        ExpansionPanel(
                            headerBuilder: (context, isOpen) {
                              return Container(
                                  ...
                                  child: Text(
                                    'Detalhamento',
                                    style: TextStyle(fontSize: 32.sp, fontFamily: 'roboto', fontWeight: FontWeight.w500, fontStyle: FontStyle.normal),
                                  ));
                            },
                            body: Container(
                                ...
                                child: Column(
                                  children: controller.inforBoletos.map((e) {
                                    ...
                                    return Column(
                                      ...
                                      children: [Text('- ${e['descricao']} - ${UIHelper.moneyFormat(e['valor'])}'), Divider()],
                                    );
                                  }).toList(),
                                )),
                            isExpanded: _isOpen)
